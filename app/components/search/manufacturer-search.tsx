...
const ManufacturerSearch = async (
    {
        companyNames,
        addresses,
    } : {
    ...
    if (walletProvider){
        ...
        try{
            ...
            const products = await contract.queryProductsByManufacturer(query);

            if(products.length === 0){
                return (
                    <h2 className="text-xl font-bold mt-5">QUERY NOT FOUND: TYPE ENTIRE MANUFACTURER NAME (CASE SENSITIVE)</h2>
                )
            }
