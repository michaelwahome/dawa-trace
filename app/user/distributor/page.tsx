...
import DistributorSearch from "@/components/search/distributor-search";
    ...
    try{
        ...
        return (
            <div className="flex flex-col gap-8">
                ...
                <Search placeholder="Search for products by distributor name"></Search>

                <Suspense >
                    <DistributorSearch companyNames={companyNames} addresses={addresses}/>
                </Suspense>
            </div>
        )
    } catch (error: any){
