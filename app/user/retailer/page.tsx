...
import RetailerSearch from "@/app/components/search/retailer-search";
    ...
    try{
        ...
        return (
            <div className="flex flex-col gap-8">
                ...
                <Search placeholder="Search for products by retailer name"></Search>

                <Suspense >
                    <RetailerSearch companyNames={companyNames} addresses={addresses}/>
                </Suspense>
            </div>
        )
    } catch (error: any){
